  ...
  return (
    <div className='w-full my-5'>
        <h1 className='text-5xl uppercase text-center my-5 font-semibold text-pink-400'>Best Sellers</h1>
            <div className='w-[98%] mx-auto grid grid-cols-5 rounded-md gap-4'>
                {bestSellers.map((bestSeller, index) => (
                    <div key={index} className='w-full h-[450px] rounded-md hover:shadow-lg hover:-translate-y-2 duration-300 cursor-default'>
